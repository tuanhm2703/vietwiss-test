...
class Router implements BindingRegistrar, RegistrarContract
{
    ...
    {
        return $this->addroute('admin.POST', $uri, $action);
    }
    ...
    {
        return $this->addroute('admin.PUT', $uri, $action);
    }
    ...
    {
        return $this->addroute('admin.PATCH', $uri, $action);
    }
    ...
    {
        return $this->addroute('admin.DELETE', $uri, $action);
    }
    ...
    {
        return $this->addroute('admin.OPTIONS', $uri, $action);
    }
